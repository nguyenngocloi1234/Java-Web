...
public class CustomerController {
    ...
    public ModelAndView saveCustomer(@Valid @ModelAttribute("customer") CustomerRequest customerRequest,
...
//
    ...
    public ModelAndView updateCustomer(@ModelAttribute("customer") CustomerRequest customer){
